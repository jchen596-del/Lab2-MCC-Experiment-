window.LAB2_C3_TRANSITIONS = {
  // Fill in the transition sentence and exact switch time for each C3 lecture.
  // If you only have the transition sentence, fill the sentence and leave time as "".
  // In that case, the website will keep the current equal-split image switching.
  // Supported time formats:
  // - "1:30"  -> 1 minute 30 seconds
  // - "01:30" -> 1 minute 30 seconds
  // - "90"    -> 90 seconds
  //
  // The sentence is for your reference.
  // The website uses the time field to decide when to switch from one image to the next.
